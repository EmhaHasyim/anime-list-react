    ...
    return (
        <>
            <section className="w-full grid grid-cols-4 grid-rows-subgrid gap-1.5">
                ...
                <div className="relative row-start-5 row-end-6 col-start-1 col-end-5 sm:row-start-4 sm:row-end-5 sm:col-start-3 lg:row-start-4 lg:row-end-5 lg:col-start-1 lg:col-end-3">
                    <div className="lg:absolute left-0 top-0 lg:h-[49.5%] w-full">
                        <ThemeMusic theme={dataDetailAnime?.data.theme} />
                    </div>
                </div>
                <div className="relative md:-mt-1.5 lg:mt-0 row-start-6 row-end-7 col-start-1 col-end-5 lg:row-start-4 lg:row-end-5 lg:col-start-1 lg:col-end-3">
                    <div className="lg:absolute left-0 bottom-0 lg:h-[49.5%] w-full">
                ...
                <div className="lg:-mt-1.5 row-start-8 row-end-9 col-start-1 col-end-5 lg:row-start-6 lg:row-end-7 lg:col-start-1 lg:col-end-3">
